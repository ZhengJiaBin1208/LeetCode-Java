...
//Java：访问完所有房间的第一天
//创建时间：2024-03-28 15:06:55
public class P1997FirstDayWhereYouHaveBeenInAllTheRooms{
    public static void main(String[] args) {
        Solution solution = new P1997FirstDayWhereYouHaveBeenInAllTheRooms().new Solution();
        // TO TEST
    }
